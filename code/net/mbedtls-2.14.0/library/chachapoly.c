...
int mbedtls_chachapoly_self_test( int verbose )
{
    ...
    for( i = 0U; i < 1U; i++ )
    {
        ...
        ASSERT_ARG( 0 == ret, ( "setkey() error code: %i\n", ret ) );
        ...
        ASSERT_ARG( 0 == ret, ( "crypt_and_tag() error code: %i\n", ret ) );

        ASSERT_ARG( 0 == memcmp( output, test_output[i], test_input_len[i] ),
                ( "failure (wrong output)\n" ) );

        ASSERT_ARG( 0 == memcmp( mac, test_mac[i], 16U ),
                ( "failure (wrong MAC)\n" ) );
